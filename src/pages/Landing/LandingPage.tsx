...
<div className={styles.roleCard}>
      ...
      {/* ── SEJA NOSSO SÓCIO ── */}
      <section className={styles.socioSection}>
        <div className={styles.socioInner}>
          <p className={styles.socioSuptitle}>Gostou do nosso sistema?</p>
          <h2 className={styles.socioTitle}>
            <span className={styles.socioDestaque}>Seja nosso sócio</span> e tenha ganhos de até{' '}
            <span className={styles.socioDestaque}>50%</span> em recorrência.
          </h2>

          <div className={styles.socioPills}>
            <div className={styles.socioPill}>
              <span>🚀</span> 1 Aplicativo novo lançado todo mês*
            </div>
            <div className={styles.socioPill}>
              <span>🎨</span> 1 Aplicativo 100% customizado ao seu gosto
            </div>
            <div className={styles.socioPill}>
              <span>♾️</span> Recorrência por toda vida
            </div>
          </div>

          <a
            href={`https://wa.me/5511933284364?text=${encodeURIComponent('Olá! Gostaria de saber mais sobre a parceria e programa de sócios do Simples Manutenção.')}`}
            target="_blank"
            rel="noopener noreferrer"
            className={styles.socioBtn}
          >
